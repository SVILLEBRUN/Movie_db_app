...
titles_origin.each do |title_origin|
  ...
  date = title_origin[-6..]
  date&.delete!('()')
  movie_titles << [title.downcase, date]
end
...
def get_data(movie_id)
  ...
  url_credits = "https://api.themoviedb.org/3/movie/#{movie_id}/credits?api_key=fde5eec290651347ef46855a96301aaa&language=fr"
  ...
  data[:actors] = api_data_credits['cast'].map do |cast_member|
    ...
    { name: cast_member['name'],
      profile_path: img_link }
  end

  url_keywords = "https://api.themoviedb.org/3/movie/#{movie_id}/keywords?api_key=fde5eec290651347ef46855a96301aaa&language=fr"
