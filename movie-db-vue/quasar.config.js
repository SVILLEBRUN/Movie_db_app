  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        VUE_APP_API_URL: ctx.dev ? 'http://localhost:880/movie-db-app/api' : 'https://sebastien-villebrun.com/movie-db-app/api',
        VUE_APP_PROXY_URL: ctx.dev ? 'http://localhost:880/proxy' : 'https://sebastien-villebrun.com/proxy'
      },
